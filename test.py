...
#print(fustal.f_test(sepal_length_setosa, sepal_length_virginica))
assert fustal.f_test(sepal_length_setosa, sepal_length_virginica) == (lambda x: x * x)(fustal.two_sample_t_test(sepal_length_setosa, sepal_length_virginica))
