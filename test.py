...
for func in [fustal.two_sample_t_test, fustal.pearson_correlation_coefficient]:
...
print(fustal.f_test(sepal_length_matr))
...
print(fustal.chi_squared_test(chisq_data));
